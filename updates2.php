	...
	<div class="container register">
		<div class="row">
			<div class="col-md-3 register-left">
				...
				<a href="display2.php">Check Form</a> <br/>
			</div>
			<div class="col-md-9 register-right">
				
				<div class="tab-content"id="myTabContent">
					<div class="tab-pane fade show active" id="home" role="tabpanel"aria-labelledby="home-tab">
						<h3 class="register-heading">Apply for Data Scientist Post</h3>
						<form action=""method="POST">
							<div class="row register-form">
								...
								$ids = $_GET['id']; 
								$showquery = "select * from data_scientist where id={$ids}";
								...
								if(isset($_POST['submit'])){
									...
									$query = "update data_scientist set id=$idupdate, name='$name',degree='$degree',
								...
								<div class="form-group">
									<input type="text" class="form-control"
									placeholder="Data Scientist post*"name="jobprofile" value="Data Scientist"/>
								</div> 
